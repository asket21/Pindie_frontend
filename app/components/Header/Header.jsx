    ...
    <header className={Styles["header"]}>
      ...
      <nav className={Styles["menu"]}>
        ...
        <div className={Styles["auth"]}>
          ...
          {authContext.isAuth ? <><li className={Styles['auth__button']}>
            <Link href="/profile" className={`${Styles["auth__button"]} ${pathname === "/profile" ? Styles["auth__button"] : ""}`}>
              Профиль
            </Link>
          </li>
            <Link href="/" className={`${Styles["auth__button"]} ${pathname === "/" ? Styles["auth__button"] : ""}`}>
              <button className={Styles["auth__button"]} onClick={handleLogOut}>
                Выйти
              </button>
            </Link></>
            : <><button className={Styles["auth__button"]} onClick={openRegestration}>
              Регистрация
      ...
      {regIsOpened && <><Overlay closePopup={closeRegestration} isOpen={regIsOpened} />
